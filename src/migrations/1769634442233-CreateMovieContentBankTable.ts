  ...
  implements MigrationInterface
{
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "movie_content_bank" ("id" SERIAL NOT NULL, "movieId" integer NOT NULL, "licensingStartDate" date NOT NULL, "licensingEndDate" date NOT NULL, "exhibitionWindow" character varying[] NOT NULL, "geolocationRestrictionCountryId" integer, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_e35f9b955ef8b3140c31a8363c4" PRIMARY KEY ("id"))`,
    )
    await queryRunner.query(
