...
export class BaselineMoviesSchema1769900000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await addFkIfPossible(
      'movies',
      'FK_movies_pedagogical',
      'pedagogicalSheetAssetId',
      'assets',
      'id',
      'SET NULL',
    )
    ...
    await addFkIfPossible(
      'movie_professionals',
      'FK_movie_professionals_professional',
      'professionalId',
      'professionals',
      'id',
      'CASCADE',
    ...
    await addFkIfPossible(
      'movie_contacts',
      'FK_movie_contacts_professional',
      'professionalId',
      'professionals',
      'id',
      'NO ACTION',
    ...
    await addFkIfPossible(
      ...
      'FK_movie_festival_nominations_movie',
      'movieId',
      'movies',
      'id',
      'CASCADE',
    ...
    await addFkIfPossible(
      'movie_festival_nominations',
      'FK_movie_festival_nominations_fund',
      'fundId',
      'funds',
      'id',
      'NO ACTION',
    ...
    await addFkIfPossible(
      ...
      'FK_movie_national_releases_movie',
      'movieId',
      'movies',
      'id',
      'CASCADE',
    ...
    await addFkIfPossible(
      'movie_national_releases',
      'FK_movie_national_releases_space',
      'exhibitionSpaceId',
      'exhibition_spaces',
      'id',
      'NO ACTION',
    ...
    await addFkIfPossible(
      'movie_national_releases',
      'FK_movie_national_releases_city',
      'cityId',
      'cities',
      'id',
      'NO ACTION',
    ...
    await addFkIfPossible(
      ...
      'FK_movie_international_releases_movie',
      'movieId',
      'movies',
      'id',
      'CASCADE',
    ...
    await addFkIfPossible(
      'movie_international_releases',
      'FK_movie_international_releases_country',
      'countryId',
      'countries',
      'id',
      'NO ACTION',
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `DROP TABLE IF EXISTS "movie_international_releases"`,
    )
    ...
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movie_content_bank_exhibitionWindow_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movie_international_releases_type_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movie_national_releases_type_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movie_festival_nominations_result_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movie_funding_fundingStage_enum"`,
    )
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movies_projectStatus_enum"`,
    )
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."movies_classification_enum"`,
    )
